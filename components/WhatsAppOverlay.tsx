    ...
    <a rel="noreferrer" target="_blank" href={`https://wa.me/${phone}`}>
      <div className="fixed bottom-[40px] right-[40px]">
        <div className="flex bg-purple-200 rounded-full items-center">
          <Span className="mx-3 hidden md:inline text-medium">{t("pet.contact_owner")}</Span>
          <div className="w-[60px] h-[60px] bg-[#25d366] text-[30px] text-white rounded-full flex items-center justify-center z-10">
